Instance: qr-findings-report
InstanceOf: ChOrfQuestionnaireResponse
Title: "QuestionnaireResponse Findings report"
...
* item[=].item[=].answer.valueString = "7098441"
...
* item[=].item[=].answer.valueString = "urn:oid:123.321.666"

* item[=].item[+].linkId = "order.precedentDocumentIdentifier"
* item[=].item[=].text = "Identifier des Vorgängerdokuments"
* item[=].item[=].answer.valueString = "f9a34cb0-1d1c-4931-937f-ef621341373c"
...
* item[=].item[=].item[=].item[=].text = "E-Mail"
* item[=].item[=].item[=].item[=].answer.valueString = "f.iller@universityhospital.ch"
...
* item[=].item[=].item[=].answer.valueString = "7601003334499"
...
* item[=].item[=].item[=].answer[0].valueString = "Musterstrasse 129"
...
* item[=].item[=].item[=].item[=].answer.valueString = "7601000099521"
...
* item[=].item[=].item[=].item[=].text = "E-Mail"
* item[=].item[=].item[=].item[=].answer.valueString = "f.iller@universityhospital.c"
...
* item[=].item[=].item[=].item[=].answer.valueString = "University Hospital"

* item[=].item[=].item[=].item[+].linkId = "orderer.author.organization.streetAddressLine"
* item[=].item[=].item[=].item[=].text = "Strasse, Hausnummer, Postfach etc."
* item[=].item[=].item[=].item[=].answer[+].valueString = "Uniweg 33"
* item[=].item[=].item[=].item[=].answer[+].valueString = "Radiology"
